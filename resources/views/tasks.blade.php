...
@section('content')
  ...
  @if (session('success'))
    ...
    <div class="flex items-center justify-between mb-5">
      ...
      <button @click="open = true" data-hasPermission="{{ $permissions['create_tasks'] }}" class="button-primary data-[hasPermission=0]:hidden">
        <span>New task</span>
      </button>
              ...
              >
                <div class="flex items-center justify-between gap-3">
                  ...
                  <div class="flex items-center gap-2">
                    <button data-hasPermission="{{ $permissions['edit_tasks'] }}" class="border-none bg-transparent data-[hasPermission=0]:hidden" @click="editTask(task)">
                    ...
                    <button @click="openDeleteModal(task)" data-hasPermission="{{ $permissions['delete_tasks'] }}" class="border-none bg-transparent data-[hasPermission=0]:hidden">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
