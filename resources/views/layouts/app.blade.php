    ...
    <div class="flex h-screen">
      ...
      <aside class="w-64 bg-white border-r flex flex-col">
        ...
        <nav class="flex flex-col p-4 space-y-2">
          ...
          <a href="{{ route('users.index') }}" class="flex items-center space-x-2 p-2 rounded {{ request()->is('users*') ? 'bg-blue-100' : 'hover:bg-blue-100' }}">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path fill-rule="evenodd" clip-rule="evenodd" d="M9 4.75C8.66848 4.75 8.35054 4.8817 8.11612 5.11612C7.8817 5.35054 7.75 5.66848 7.75 6V15C7.75 15.3315 7.8817 15.6495 8.11612 15.8839C8.35054 16.1183 8.66848 16.25 9 16.25H19C19.3315 16.25 19.6495 16.1183 19.8839 15.8839C20.1183 15.6495 20.25 15.3315 20.25 15V8C20.25 7.66848 20.1183 7.35054 19.8839 7.11612C19.6495 6.8817 19.3315 6.75 19 6.75H14C13.8011 6.75 13.6103 6.67098 13.4697 6.53033L11.6893 4.75H9ZM7.05546 4.05546C7.57118 3.53973 8.27065 3.25 9 3.25H12C12.1989 3.25 12.3897 3.32902 12.5303 3.46967L14.3107 5.25H19C19.7293 5.25 20.4288 5.53973 20.9445 6.05546C21.4603 6.57118 21.75 7.27065 21.75 8V15C21.75 15.7293 21.4603 16.4288 20.9445 16.9445C20.4288 17.4603 19.7293 17.75 19 17.75H9C8.27065 17.75 7.57118 17.4603 7.05546 16.9445C6.53973 16.4288 6.25 15.7293 6.25 15V6C6.25 5.27065 6.53973 4.57118 7.05546 4.05546Z" fill="#14367B"/>
              <path fill-rule="evenodd" clip-rule="evenodd" d="M5 8.75C4.66848 8.75 4.35054 8.8817 4.11612 9.11612C3.8817 9.35054 3.75 9.66848 3.75 10V19C3.75 19.3315 3.8817 19.6495 4.11612 19.8839C4.35054 20.1183 4.66848 20.25 5 20.25H15C15.3315 20.25 15.6495 20.1183 15.8839 19.8839C16.1183 19.6495 16.25 19.3315 16.25 19V17C16.25 16.5858 16.5858 16.25 17 16.25C17.4142 16.25 17.75 16.5858 17.75 17V19C17.75 19.7293 17.4603 20.4288 16.9445 20.9445C16.4288 21.4603 15.7293 21.75 15 21.75H5C4.27065 21.75 3.57118 21.4603 3.05546 20.9445C2.53973 20.4288 2.25 19.7293 2.25 19V10C2.25 9.27065 2.53973 8.57118 3.05546 8.05546C3.57118 7.53973 4.27065 7.25 5 7.25H7C7.41421 7.25 7.75 7.58579 7.75 8C7.75 8.41421 7.41421 8.75 7 8.75H5Z" fill="#14367B"/>
              </svg>
            <span>Users</span>
          </a>
          <a href="{{ route('tasks.index') }}" class="flex items-center space-x-2 p-2 rounded {{ request()->is('overview*') ? 'bg-blue-100' : 'hover:bg-blue-100' }}">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
